...
[_sentry1, getPos base_independent_flagpole, 50, 2, true] call CBA_fnc_taskDefend;
[_sentry2, getPos base_independent_flagpole, 50, 2, true] call CBA_fnc_taskDefend;
[_sentry3, getPos base_independent_flagpole, 50, 2, true] call CBA_fnc_taskDefend;
[_sentry4, getPos base_independent_flagpole, 50, 2, true] call CBA_fnc_taskDefend;
...
_position = getPos base_independent_flagpole findEmptyPosition [1,50];
_patrol5 = [_position, resistance, (configFile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfSentry")] call BIS_fnc_spawnGroup;

_position = getPos base_independent_flagpole findEmptyPosition [1,50];
_patrol6 = [_position, resistance, (configFile >> "CfgGroups" >> "Indep" >> "IND_F" >> "Infantry" >> "HAF_InfSentry")] call BIS_fnc_spawnGroup;
...
[_patrol5, getPos base_independent_flagpole, 100, 7, "MOVE", "SAFE", "RED", "LIMITED", "STAG COLUMN", "this spawn CBA_fnc_taskSearchHouse", [3,7,15]] call CBA_fnc_taskPatrol;
[_patrol6, getPos base_independent_flagpole, 100, 8, "MOVE", "SAFE", "RED", "LIMITED", "STAG COLUMN", "this spawn CBA_fnc_taskSearchHouse", [3,7,15]] call CBA_fnc_taskPatrol;
...
{ UnitsBase pushBack _x; } forEach units _patrol5;
{ UnitsBase pushBack _x; } forEach units _patrol6;
